      ...
      <div className="sticky top-0 w-full h-[100dvh] flex flex-col justify-between pt-14 sm:pt-20 lg:pt-24 pb-4 sm:pb-8 lg:pb-12 px-4 sm:px-8 lg:px-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col md:flex-row md:items-end justify-between gap-2 sm:gap-6 shrink-0">
          ...
          <div className="flex flex-col gap-1 sm:gap-2 max-w-md">
            <p className="text-slate-600 text-xs sm:text-sm md:text-base leading-relaxed font-normal line-clamp-2 sm:line-clamp-none">
          ...
          <div className="col-span-1 lg:col-span-7 relative flex items-center justify-center z-10 h-[340px] xs:h-[370px] sm:h-[400px] lg:h-[440px]">
            {services.map((service, idx) => {
              ...
              return (
                ...
                >
                  {isRevealed && (
                    <div className="absolute top-0 right-0 w-36 sm:w-48 h-36 sm:h-48 bg-gradient-to-bl from-blue-600/30 via-purple-600/15 to-transparent rounded-full blur-2xl pointer-events-none" />
                  )}
                  ...
                  >
                    {isRevealed && (
                      <>
                        <span className="text-[9px] sm:text-[11px] font-mono font-bold uppercase tracking-[0.2em] text-[#3B82F6]">
                          {service.category}
                        </span>
                        ...
                        <div className="flex flex-wrap gap-1 pt-0.5">
                          {service.tags.slice(0, 3).map((tag) => (
                            <span
                              key={tag}
                              className="px-2 py-0.5 bg-white/10 rounded-full text-[9px] sm:text-[11px] font-mono text-zinc-200 border border-white/10"
                            >
                              {tag}
                            </span>
                          ))}
